...
def get_torchbiggraph_config():
    ...
    config = {
        # I/O data
        "entity_path": "./data/biggraph/s2orc_full",
        "edge_paths": [            
            "./data/biggraph/s2orc_full/train_partitioned",
        ],
        "checkpoint_path": "./data/biggraph/models/s2orc_1024d",
        ...
        # Scoring model
        "dimension": 1024,  #300,  # 500,  # maybe d=768 to make it comparable to BERT
        "max_norm": 1.0,
        "global_emb": False,
        "comparator": "dot",
