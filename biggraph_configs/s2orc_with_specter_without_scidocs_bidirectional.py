...
def get_torchbiggraph_config():
    ...
    config = {
        # I/O data
        "entity_path": "./data/biggraph/s2orc_with_specter_without_scidocs_bidirectional",
        "edge_paths": [            
            "./data/biggraph/s2orc_with_specter_without_scidocs_bidirectional/train_partitioned",
        ],
        "checkpoint_path": "./data/biggraph/s2orc_with_specter_without_scidocs_bidirectional",
