...
def get_torchbiggraph_config():
    ...
    config = {
        # I/O data
        "entity_path": "./data/biggraph/s2orc_without_scidocs_1m",
        "edge_paths": [            
            "./data/biggraph/s2orc_without_scidocs_1m/train_partitioned",
        ],
        "checkpoint_path": "./data/biggraph/s2orc_without_scidocs_1m",
