...
class DebertaForTripletLoss(DebertaPreTrainedModel):
    def __init__(
            self,
            config,
            loss_func=None,
        ...
        self.masked_language_modeling, self.masked_language_modeling_weight, self.cls = get_mlm(
            masked_language_modeling, masked_language_modeling_weight, DebertaOnlyMLMHead(config))
